...
`${GOPATH}/src/github.com/lrettig/smeshbeat`
...
```
git remote set-url origin https://github.com/lrettig/smeshbeat
...
in the same directory with the name smeshbeat.
...
```
mkdir -p ${GOPATH}/src/github.com/lrettig/smeshbeat
git clone https://github.com/lrettig/smeshbeat ${GOPATH}/src/github.com/lrettig/smeshbeat
```
